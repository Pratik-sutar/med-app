...
export default function LoginPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    // Mock authentication
    if (email === "testing@mail.com" && password === "123456") {
      localStorage.setItem("token", "ajhsgxjhashvjsjv")
      alert("Login successful! Welcome to MedApp.");
      router.push("/dashboard");
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
              Access your medical appointment platform
            </p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="text-right">
              <button
                type="button"
                onClick={() => alert("Forgot password feature (mock)")}
          ...
          <button
            type="button"
            onClick={() => alert("Create account feature (mock)")}
            className="w-full bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-200 font-medium py-3 rounded-lg border border-gray-300 dark:border-gray-600 transition-colors"
          >
            Create Account
          </button>
        </div>
